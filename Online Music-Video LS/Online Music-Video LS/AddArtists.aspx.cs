...
namespace Online_Music_Video_LS
{
    public partial class AddArtists : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "Insert into Artists values(' " + TextBox11.Text + " ','" + TextBox33.Text + "')";
            cmd.ExecuteNonQuery();
            //Label1.Text = "New Artist Added !";
            Response.Write("<script>alert('New Artist Added !')</script>");
            con.Close();
            GridView1.DataBind();
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AddArtists.aspx");
        }
    }
}
