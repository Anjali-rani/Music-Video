<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="Online_Music_Video_LS.AddCategory" %>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <asp:TextBox name="Name" type="text" placeholder="Category" 
          class="form-control input-md" ID="TextBox11" runat="server" 
          CausesValidation="True"></asp:TextBox>

               <asp:RequiredFieldValidator
            ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter Category Name"
          ...
          Text="Add"
            ...
            Text="Cancel"
                        onclick="Button2_Click" CausesValidation="False" />
                         &nbsp; <b><i><a href="#down" style="color: #FF0000">View Categories </a></i></b>
    <br /><br />
...
<asp:GridView ID="GridView1" runat="server" AllowSorting="True" CssClass="table table table-bordered table-hover"
    ...
    BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="CName" 
