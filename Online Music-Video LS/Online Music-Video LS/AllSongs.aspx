<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" CodeBehind="AllSongs.aspx.cs" Inherits="Online_Music_Video_LS.AllSongs1" %>
    ...
    <section class="py-5" style="background-image:url('img/bg-masthead.jpg'); height: 100%; width: 100%;"> 
      ...
      <center>
       ...
       <br /><br /><br /><br />
        ...
        <h3 style="color: #FFFFFF">  All Songs (MP3/MP4)
<br /><br />
            <asp:Button ID="Button1" runat="server" Text="MP3" class="btn btn-primary" 
        PostBackUrl="AllSongsmp3.aspx" Height="50px" Width="120px"/>
        <asp:Button ID="Button2" runat="server" Text="MP4" class="btn btn-primary" 
        PostBackUrl="AllSongsmp4.aspx" Height="50px" Width="120px"/>
           </h3>
          <br /><br />
